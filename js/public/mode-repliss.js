ace.define('ace/mode/repliss', ['require', 'exports', 'module' , 'ace/lib/oop', 'ace/mode/javascript', 'ace/tokenizer', 'ace/mode/repliss_highlight_rules'], function(require, exports, module) {


    var oop = require("../lib/oop");
    var JavaScriptMode = require("./javascript").Mode;
    var Tokenizer = require("../tokenizer").Tokenizer;
    var ReplissHighlightRules = require("./repliss_highlight_rules").ReplissHighlightRules;

    var Mode = function() {
        JavaScriptMode.call(this);

        this.HighlightRules = ReplissHighlightRules;
    };
...
ace.define('ace/mode/repliss_highlight_rules', ['require', 'exports', 'module' , 'ace/lib/oop', 'ace/mode/doc_comment_highlight_rules', 'ace/mode/text_highlight_rules'], function(require, exports, module) {
    ...
    var ReplissHighlightRules = function() {
        ...
        var langClasses = (
            ...
            "Unit|Any|AnyVal|AnyRef|Null|ReplissObject|Singleton|Seq|Iterable|List|" +
    ...
    oop.inherits(ReplissHighlightRules, TextHighlightRules);

    exports.ReplissHighlightRules = ReplissHighlightRules;
});
