...
DLL_VIS JNIEXPORT void JNICALL Java_com_microsoft_z3_Native_INTERNALglobalParamSet(JNIEnv * jenv, jclass cls, jstring a0, jstring a1) {
  ...
  jenv->ReleaseStringUTFChars(a0, _a0);
  jenv->ReleaseStringUTFChars(a1, _a1);
}
...
DLL_VIS JNIEXPORT jboolean JNICALL Java_com_microsoft_z3_Native_INTERNALglobalParamGet(JNIEnv * jenv, jclass cls, jstring a0, jobject a1) {
  Z3_string _a0 = (Z3_string) jenv->GetStringUTFChars(a0, NULL);
  Z3_string _a1;
  bool result = Z3_global_param_get(_a0, &_a1);
  jenv->ReleaseStringUTFChars(a0, _a0);
  {
...
DLL_VIS JNIEXPORT void JNICALL Java_com_microsoft_z3_Native_INTERNALsetParamValue(JNIEnv * jenv, jclass cls, jlong a0, jstring a1, jstring a2) {
  ...
  jenv->ReleaseStringUTFChars(a1, _a1);
  jenv->ReleaseStringUTFChars(a2, _a2);
}
...
DLL_VIS JNIEXPORT void JNICALL Java_com_microsoft_z3_Native_INTERNALparamsSetBool(JNIEnv * jenv, jclass cls, jlong a0, jlong a1, jlong a2, jboolean a3) {
  Z3_params_set_bool((Z3_context)a0, (Z3_params)a1, (Z3_symbol)a2, (bool)a3);
}
...
DLL_VIS JNIEXPORT jlong JNICALL Java_com_microsoft_z3_Native_INTERNALmkFiniteDomainSort(JNIEnv * jenv, jclass cls, jlong a0, jlong a1, jlong a2) {
  Z3_sort result = Z3_mk_finite_domain_sort((Z3_context)a0, (Z3_symbol)a1, (uint64_t)a2);
  return (jlong) result;
}
...
DLL_VIS JNIEXPORT jlong JNICALL Java_com_microsoft_z3_Native_INTERNALmkArraySortN(JNIEnv * jenv, jclass cls, jlong a0, jint a1, jlongArray a2, jlong a3) {
  GETLONGAELEMS(Z3_sort, a2, _a2);
  Z3_sort result = Z3_mk_array_sort_n((Z3_context)a0, (unsigned)a1, _a2, (Z3_sort)a3);
...
DLL_VIS JNIEXPORT jlong JNICALL Java_com_microsoft_z3_Native_INTERNALmkRecFuncDecl(JNIEnv * jenv, jclass cls, jlong a0, jlong a1, jint a2, jlongArray a3, jlong a4) {
  GETLONGAELEMS(Z3_sort, a3, _a3);
  Z3_func_decl result = Z3_mk_rec_func_decl((Z3_context)a0, (Z3_symbol)a1, (unsigned)a2, _a3, (Z3_sort)a4);
  RELEASELONGAELEMS(a3, _a3);
  return (jlong) result;
}
DLL_VIS JNIEXPORT void JNICALL Java_com_microsoft_z3_Native_INTERNALaddRecDef(JNIEnv * jenv, jclass cls, jlong a0, jlong a1, jint a2, jlongArray a3, jlong a4) {
  GETLONGAELEMS(Z3_ast, a3, _a3);
  Z3_add_rec_def((Z3_context)a0, (Z3_func_decl)a1, (unsigned)a2, _a3, (Z3_ast)a4);
  RELEASELONGAELEMS(a3, _a3);
}
...
DLL_VIS JNIEXPORT jlong JNICALL Java_com_microsoft_z3_Native_INTERNALmkDivides(JNIEnv * jenv, jclass cls, jlong a0, jlong a1, jlong a2) {
  Z3_ast result = Z3_mk_divides((Z3_context)a0, (Z3_ast)a1, (Z3_ast)a2);
  return (jlong) result;
}
...
DLL_VIS JNIEXPORT jlong JNICALL Java_com_microsoft_z3_Native_INTERNALmkBv2int(JNIEnv * jenv, jclass cls, jlong a0, jlong a1, jboolean a2) {
  Z3_ast result = Z3_mk_bv2int((Z3_context)a0, (Z3_ast)a1, (bool)a2);
  return (jlong) result;
}
DLL_VIS JNIEXPORT jlong JNICALL Java_com_microsoft_z3_Native_INTERNALmkBvaddNoOverflow(JNIEnv * jenv, jclass cls, jlong a0, jlong a1, jlong a2, jboolean a3) {
  Z3_ast result = Z3_mk_bvadd_no_overflow((Z3_context)a0, (Z3_ast)a1, (Z3_ast)a2, (bool)a3);
  return (jlong) result;
}
...
DLL_VIS JNIEXPORT jlong JNICALL Java_com_microsoft_z3_Native_INTERNALmkBvsubNoUnderflow(JNIEnv * jenv, jclass cls, jlong a0, jlong a1, jlong a2, jboolean a3) {
  Z3_ast result = Z3_mk_bvsub_no_underflow((Z3_context)a0, (Z3_ast)a1, (Z3_ast)a2, (bool)a3);
  return (jlong) result;
}
...
DLL_VIS JNIEXPORT jlong JNICALL Java_com_microsoft_z3_Native_INTERNALmkBvmulNoOverflow(JNIEnv * jenv, jclass cls, jlong a0, jlong a1, jlong a2, jboolean a3) {
  Z3_ast result = Z3_mk_bvmul_no_overflow((Z3_context)a0, (Z3_ast)a1, (Z3_ast)a2, (bool)a3);
  return (jlong) result;
}
...
DLL_VIS JNIEXPORT jlong JNICALL Java_com_microsoft_z3_Native_INTERNALmkSelectN(JNIEnv * jenv, jclass cls, jlong a0, jlong a1, jint a2, jlongArray a3) {
  GETLONGAELEMS(Z3_ast, a3, _a3);
  Z3_ast result = Z3_mk_select_n((Z3_context)a0, (Z3_ast)a1, (unsigned)a2, _a3);
  RELEASELONGAELEMS(a3, _a3);
  return (jlong) result;
}
...
DLL_VIS JNIEXPORT jlong JNICALL Java_com_microsoft_z3_Native_INTERNALmkStoreN(JNIEnv * jenv, jclass cls, jlong a0, jlong a1, jint a2, jlongArray a3, jlong a4) {
  GETLONGAELEMS(Z3_ast, a3, _a3);
  Z3_ast result = Z3_mk_store_n((Z3_context)a0, (Z3_ast)a1, (unsigned)a2, _a3, (Z3_ast)a4);
  RELEASELONGAELEMS(a3, _a3);
  return (jlong) result;
}
...
DLL_VIS JNIEXPORT jlong JNICALL Java_com_microsoft_z3_Native_INTERNALmkAsArray(JNIEnv * jenv, jclass cls, jlong a0, jlong a1) {
  Z3_ast result = Z3_mk_as_array((Z3_context)a0, (Z3_func_decl)a1);
  return (jlong) result;
}
DLL_VIS JNIEXPORT jlong JNICALL Java_com_microsoft_z3_Native_INTERNALmkSetHasSize(JNIEnv * jenv, jclass cls, jlong a0, jlong a1, jlong a2) {
  Z3_ast result = Z3_mk_set_has_size((Z3_context)a0, (Z3_ast)a1, (Z3_ast)a2);
  return (jlong) result;
}
...
DLL_VIS JNIEXPORT jlong JNICALL Java_com_microsoft_z3_Native_INTERNALmkInt64(JNIEnv * jenv, jclass cls, jlong a0, jlong a1, jlong a2) {
  Z3_ast result = Z3_mk_int64((Z3_context)a0, (int64_t)a1, (Z3_sort)a2);
  return (jlong) result;
}
DLL_VIS JNIEXPORT jlong JNICALL Java_com_microsoft_z3_Native_INTERNALmkUnsignedInt64(JNIEnv * jenv, jclass cls, jlong a0, jlong a1, jlong a2) {
  Z3_ast result = Z3_mk_unsigned_int64((Z3_context)a0, (uint64_t)a1, (Z3_sort)a2);
  return (jlong) result;
}
DLL_VIS JNIEXPORT jlong JNICALL Java_com_microsoft_z3_Native_INTERNALmkBvNumeral(JNIEnv * jenv, jclass cls, jlong a0, jint a1, jintArray a2) {
  bool * _a2 = (bool*) jenv->GetIntArrayElements(a2, NULL);
  Z3_ast result = Z3_mk_bv_numeral((Z3_context)a0, (unsigned)a1, _a2);
  jenv->ReleaseIntArrayElements(a2, (jint*)_a2, JNI_ABORT);
  return (jlong) result;
}
...
DLL_VIS JNIEXPORT jboolean JNICALL Java_com_microsoft_z3_Native_INTERNALisSeqSort(JNIEnv * jenv, jclass cls, jlong a0, jlong a1) {
  bool result = Z3_is_seq_sort((Z3_context)a0, (Z3_sort)a1);
  return (jboolean) result;
}
DLL_VIS JNIEXPORT jlong JNICALL Java_com_microsoft_z3_Native_INTERNALgetSeqSortBasis(JNIEnv * jenv, jclass cls, jlong a0, jlong a1) {
  Z3_sort result = Z3_get_seq_sort_basis((Z3_context)a0, (Z3_sort)a1);
  return (jlong) result;
}
...
DLL_VIS JNIEXPORT jboolean JNICALL Java_com_microsoft_z3_Native_INTERNALisReSort(JNIEnv * jenv, jclass cls, jlong a0, jlong a1) {
  bool result = Z3_is_re_sort((Z3_context)a0, (Z3_sort)a1);
  return (jboolean) result;
}
DLL_VIS JNIEXPORT jlong JNICALL Java_com_microsoft_z3_Native_INTERNALgetReSortBasis(JNIEnv * jenv, jclass cls, jlong a0, jlong a1) {
  Z3_sort result = Z3_get_re_sort_basis((Z3_context)a0, (Z3_sort)a1);
  return (jlong) result;
}
...
DLL_VIS JNIEXPORT jboolean JNICALL Java_com_microsoft_z3_Native_INTERNALisStringSort(JNIEnv * jenv, jclass cls, jlong a0, jlong a1) {
  bool result = Z3_is_string_sort((Z3_context)a0, (Z3_sort)a1);
  return (jboolean) result;
}
...
DLL_VIS JNIEXPORT jlong JNICALL Java_com_microsoft_z3_Native_INTERNALmkLstring(JNIEnv * jenv, jclass cls, jlong a0, jint a1, jstring a2) {
  Z3_string _a2 = (Z3_string) jenv->GetStringUTFChars(a2, NULL);
  Z3_ast result = Z3_mk_lstring((Z3_context)a0, (unsigned)a1, _a2);
  jenv->ReleaseStringUTFChars(a2, _a2);
  return (jlong) result;
}
DLL_VIS JNIEXPORT jboolean JNICALL Java_com_microsoft_z3_Native_INTERNALisString(JNIEnv * jenv, jclass cls, jlong a0, jlong a1) {
  bool result = Z3_is_string((Z3_context)a0, (Z3_ast)a1);
  return (jboolean) result;
}
...
DLL_VIS JNIEXPORT jlong JNICALL Java_com_microsoft_z3_Native_INTERNALgetLstring(JNIEnv * jenv, jclass cls, jlong a0, jlong a1, jobject a2) {
  unsigned _a2;
  Z3_char_ptr result = Z3_get_lstring((Z3_context)a0, (Z3_ast)a1, &_a2);
  {
...
DLL_VIS JNIEXPORT jlong JNICALL Java_com_microsoft_z3_Native_INTERNALmkStrLt(JNIEnv * jenv, jclass cls, jlong a0, jlong a1, jlong a2) {
  Z3_ast result = Z3_mk_str_lt((Z3_context)a0, (Z3_ast)a1, (Z3_ast)a2);
  return (jlong) result;
}
DLL_VIS JNIEXPORT jlong JNICALL Java_com_microsoft_z3_Native_INTERNALmkStrLe(JNIEnv * jenv, jclass cls, jlong a0, jlong a1, jlong a2) {
  Z3_ast result = Z3_mk_str_le((Z3_context)a0, (Z3_ast)a1, (Z3_ast)a2);
  return (jlong) result;
}
...
DLL_VIS JNIEXPORT jlong JNICALL Java_com_microsoft_z3_Native_INTERNALmkSeqNth(JNIEnv * jenv, jclass cls, jlong a0, jlong a1, jlong a2) {
  Z3_ast result = Z3_mk_seq_nth((Z3_context)a0, (Z3_ast)a1, (Z3_ast)a2);
  return (jlong) result;
}
...
DLL_VIS JNIEXPORT jlong JNICALL Java_com_microsoft_z3_Native_INTERNALmkSeqLastIndex(JNIEnv * jenv, jclass cls, jlong a0, jlong a1, jlong a2) {
  Z3_ast result = Z3_mk_seq_last_index((Z3_context)a0, (Z3_ast)a1, (Z3_ast)a2);
  return (jlong) result;
}
DLL_VIS JNIEXPORT jlong JNICALL Java_com_microsoft_z3_Native_INTERNALmkStrToInt(JNIEnv * jenv, jclass cls, jlong a0, jlong a1) {
  Z3_ast result = Z3_mk_str_to_int((Z3_context)a0, (Z3_ast)a1);
  return (jlong) result;
}
DLL_VIS JNIEXPORT jlong JNICALL Java_com_microsoft_z3_Native_INTERNALmkIntToStr(JNIEnv * jenv, jclass cls, jlong a0, jlong a1) {
  Z3_ast result = Z3_mk_int_to_str((Z3_context)a0, (Z3_ast)a1);
  return (jlong) result;
}
...
DLL_VIS JNIEXPORT jlong JNICALL Java_com_microsoft_z3_Native_INTERNALmkReRange(JNIEnv * jenv, jclass cls, jlong a0, jlong a1, jlong a2) {
  Z3_ast result = Z3_mk_re_range((Z3_context)a0, (Z3_ast)a1, (Z3_ast)a2);
  return (jlong) result;
}
DLL_VIS JNIEXPORT jlong JNICALL Java_com_microsoft_z3_Native_INTERNALmkReLoop(JNIEnv * jenv, jclass cls, jlong a0, jlong a1, jint a2, jint a3) {
  Z3_ast result = Z3_mk_re_loop((Z3_context)a0, (Z3_ast)a1, (unsigned)a2, (unsigned)a3);
  return (jlong) result;
}
DLL_VIS JNIEXPORT jlong JNICALL Java_com_microsoft_z3_Native_INTERNALmkReIntersect(JNIEnv * jenv, jclass cls, jlong a0, jint a1, jlongArray a2) {
  GETLONGAELEMS(Z3_ast, a2, _a2);
  Z3_ast result = Z3_mk_re_intersect((Z3_context)a0, (unsigned)a1, _a2);
  RELEASELONGAELEMS(a2, _a2);
  return (jlong) result;
}
DLL_VIS JNIEXPORT jlong JNICALL Java_com_microsoft_z3_Native_INTERNALmkReComplement(JNIEnv * jenv, jclass cls, jlong a0, jlong a1) {
  Z3_ast result = Z3_mk_re_complement((Z3_context)a0, (Z3_ast)a1);
  return (jlong) result;
}
DLL_VIS JNIEXPORT jlong JNICALL Java_com_microsoft_z3_Native_INTERNALmkReEmpty(JNIEnv * jenv, jclass cls, jlong a0, jlong a1) {
  Z3_ast result = Z3_mk_re_empty((Z3_context)a0, (Z3_sort)a1);
  return (jlong) result;
}
DLL_VIS JNIEXPORT jlong JNICALL Java_com_microsoft_z3_Native_INTERNALmkReFull(JNIEnv * jenv, jclass cls, jlong a0, jlong a1) {
  Z3_ast result = Z3_mk_re_full((Z3_context)a0, (Z3_sort)a1);
  return (jlong) result;
}
DLL_VIS JNIEXPORT jlong JNICALL Java_com_microsoft_z3_Native_INTERNALmkLinearOrder(JNIEnv * jenv, jclass cls, jlong a0, jlong a1, jint a2) {
  Z3_func_decl result = Z3_mk_linear_order((Z3_context)a0, (Z3_sort)a1, (unsigned)a2);
  return (jlong) result;
}
DLL_VIS JNIEXPORT jlong JNICALL Java_com_microsoft_z3_Native_INTERNALmkPartialOrder(JNIEnv * jenv, jclass cls, jlong a0, jlong a1, jint a2) {
  Z3_func_decl result = Z3_mk_partial_order((Z3_context)a0, (Z3_sort)a1, (unsigned)a2);
  return (jlong) result;
}
DLL_VIS JNIEXPORT jlong JNICALL Java_com_microsoft_z3_Native_INTERNALmkPiecewiseLinearOrder(JNIEnv * jenv, jclass cls, jlong a0, jlong a1, jint a2) {
  Z3_func_decl result = Z3_mk_piecewise_linear_order((Z3_context)a0, (Z3_sort)a1, (unsigned)a2);
  return (jlong) result;
}
DLL_VIS JNIEXPORT jlong JNICALL Java_com_microsoft_z3_Native_INTERNALmkTreeOrder(JNIEnv * jenv, jclass cls, jlong a0, jlong a1, jint a2) {
  Z3_func_decl result = Z3_mk_tree_order((Z3_context)a0, (Z3_sort)a1, (unsigned)a2);
  return (jlong) result;
}
DLL_VIS JNIEXPORT jlong JNICALL Java_com_microsoft_z3_Native_INTERNALmkTransitiveClosure(JNIEnv * jenv, jclass cls, jlong a0, jlong a1) {
  Z3_func_decl result = Z3_mk_transitive_closure((Z3_context)a0, (Z3_func_decl)a1);
  return (jlong) result;
}
...
DLL_VIS JNIEXPORT jlong JNICALL Java_com_microsoft_z3_Native_INTERNALmkQuantifier(JNIEnv * jenv, jclass cls, jlong a0, jboolean a1, jint a2, jint a3, jlongArray a4, jint a5, jlongArray a6, jlongArray a7, jlong a8) {
  ...
  Z3_ast result = Z3_mk_quantifier((Z3_context)a0, (bool)a1, (unsigned)a2, (unsigned)a3, _a4, (unsigned)a5, _a6, _a7, (Z3_ast)a8);
  RELEASELONGAELEMS(a4, _a4);
  RELEASELONGAELEMS(a6, _a6);
...
DLL_VIS JNIEXPORT jlong JNICALL Java_com_microsoft_z3_Native_INTERNALmkQuantifierEx(JNIEnv * jenv, jclass cls, jlong a0, jboolean a1, jint a2, jlong a3, jlong a4, jint a5, jlongArray a6, jint a7, jlongArray a8, jint a9, jlongArray a10, jlongArray a11, jlong a12) {
  ...
  Z3_ast result = Z3_mk_quantifier_ex((Z3_context)a0, (bool)a1, (unsigned)a2, (Z3_symbol)a3, (Z3_symbol)a4, (unsigned)a5, _a6, (unsigned)a7, _a8, (unsigned)a9, _a10, _a11, (Z3_ast)a12);
  RELEASELONGAELEMS(a6, _a6);
...
DLL_VIS JNIEXPORT jlong JNICALL Java_com_microsoft_z3_Native_INTERNALmkQuantifierConst(JNIEnv * jenv, jclass cls, jlong a0, jboolean a1, jint a2, jint a3, jlongArray a4, jint a5, jlongArray a6, jlong a7) {
  ...
  GETLONGAELEMS(Z3_pattern, a6, _a6);
  Z3_ast result = Z3_mk_quantifier_const((Z3_context)a0, (bool)a1, (unsigned)a2, (unsigned)a3, _a4, (unsigned)a5, _a6, (Z3_ast)a7);
  RELEASELONGAELEMS(a4, _a4);
  RELEASELONGAELEMS(a6, _a6);
  return (jlong) result;
}
DLL_VIS JNIEXPORT jlong JNICALL Java_com_microsoft_z3_Native_INTERNALmkQuantifierConstEx(JNIEnv * jenv, jclass cls, jlong a0, jboolean a1, jint a2, jlong a3, jlong a4, jint a5, jlongArray a6, jint a7, jlongArray a8, jint a9, jlongArray a10, jlong a11) {
  ...
  Z3_ast result = Z3_mk_quantifier_const_ex((Z3_context)a0, (bool)a1, (unsigned)a2, (Z3_symbol)a3, (Z3_symbol)a4, (unsigned)a5, _a6, (unsigned)a7, _a8, (unsigned)a9, _a10, (Z3_ast)a11);
  RELEASELONGAELEMS(a6, _a6);
  RELEASELONGAELEMS(a8, _a8);
  RELEASELONGAELEMS(a10, _a10);
  return (jlong) result;
}
DLL_VIS JNIEXPORT jlong JNICALL Java_com_microsoft_z3_Native_INTERNALmkLambda(JNIEnv * jenv, jclass cls, jlong a0, jint a1, jlongArray a2, jlongArray a3, jlong a4) {
  GETLONGAELEMS(Z3_sort, a2, _a2);
  GETLONGAELEMS(Z3_symbol, a3, _a3);
  Z3_ast result = Z3_mk_lambda((Z3_context)a0, (unsigned)a1, _a2, _a3, (Z3_ast)a4);
  RELEASELONGAELEMS(a2, _a2);
  RELEASELONGAELEMS(a3, _a3);
  return (jlong) result;
}
DLL_VIS JNIEXPORT jlong JNICALL Java_com_microsoft_z3_Native_INTERNALmkLambdaConst(JNIEnv * jenv, jclass cls, jlong a0, jint a1, jlongArray a2, jlong a3) {
  GETLONGAELEMS(Z3_app, a2, _a2);
  Z3_ast result = Z3_mk_lambda_const((Z3_context)a0, (unsigned)a1, _a2, (Z3_ast)a3);
  RELEASELONGAELEMS(a2, _a2);
  return (jlong) result;
}
...
DLL_VIS JNIEXPORT jboolean JNICALL Java_com_microsoft_z3_Native_INTERNALisEqSort(JNIEnv * jenv, jclass cls, jlong a0, jlong a1, jlong a2) {
  bool result = Z3_is_eq_sort((Z3_context)a0, (Z3_sort)a1, (Z3_sort)a2);
  return (jboolean) result;
}
...
DLL_VIS JNIEXPORT jboolean JNICALL Java_com_microsoft_z3_Native_INTERNALgetFiniteDomainSortSize(JNIEnv * jenv, jclass cls, jlong a0, jlong a1, jobject a2) {
  uint64_t _a2;
  bool result = Z3_get_finite_domain_sort_size((Z3_context)a0, (Z3_sort)a1, &_a2);
  {
     jclass mc    = jenv->GetObjectClass(a2);
     jfieldID fid = jenv->GetFieldID(mc, "value", "J");
...
DLL_VIS JNIEXPORT jlong JNICALL Java_com_microsoft_z3_Native_INTERNALmkAtleast(JNIEnv * jenv, jclass cls, jlong a0, jint a1, jlongArray a2, jint a3) {
  GETLONGAELEMS(Z3_ast, a2, _a2);
  Z3_ast result = Z3_mk_atleast((Z3_context)a0, (unsigned)a1, _a2, (unsigned)a3);
  RELEASELONGAELEMS(a2, _a2);
  return (jlong) result;
}
...
DLL_VIS JNIEXPORT jlong JNICALL Java_com_microsoft_z3_Native_INTERNALmkPbge(JNIEnv * jenv, jclass cls, jlong a0, jint a1, jlongArray a2, jintArray a3, jint a4) {
  GETLONGAELEMS(Z3_ast, a2, _a2);
  int * _a3 = (int*) jenv->GetIntArrayElements(a3, NULL);
  Z3_ast result = Z3_mk_pbge((Z3_context)a0, (unsigned)a1, _a2, _a3, (int)a4);
  RELEASELONGAELEMS(a2, _a2);
  jenv->ReleaseIntArrayElements(a3, (jint*)_a3, JNI_ABORT);
  return (jlong) result;
}
...
DLL_VIS JNIEXPORT jboolean JNICALL Java_com_microsoft_z3_Native_INTERNALisEqFuncDecl(JNIEnv * jenv, jclass cls, jlong a0, jlong a1, jlong a2) {
  bool result = Z3_is_eq_func_decl((Z3_context)a0, (Z3_func_decl)a1, (Z3_func_decl)a2);
  return (jboolean) result;
}
...
DLL_VIS JNIEXPORT jboolean JNICALL Java_com_microsoft_z3_Native_INTERNALisEqAst(JNIEnv * jenv, jclass cls, jlong a0, jlong a1, jlong a2) {
  bool result = Z3_is_eq_ast((Z3_context)a0, (Z3_ast)a1, (Z3_ast)a2);
  return (jboolean) result;
}
...
DLL_VIS JNIEXPORT jboolean JNICALL Java_com_microsoft_z3_Native_INTERNALisWellSorted(JNIEnv * jenv, jclass cls, jlong a0, jlong a1) {
  bool result = Z3_is_well_sorted((Z3_context)a0, (Z3_ast)a1);
  return (jboolean) result;
}
...
DLL_VIS JNIEXPORT jboolean JNICALL Java_com_microsoft_z3_Native_INTERNALisApp(JNIEnv * jenv, jclass cls, jlong a0, jlong a1) {
  bool result = Z3_is_app((Z3_context)a0, (Z3_ast)a1);
  return (jboolean) result;
}
DLL_VIS JNIEXPORT jboolean JNICALL Java_com_microsoft_z3_Native_INTERNALisNumeralAst(JNIEnv * jenv, jclass cls, jlong a0, jlong a1) {
  bool result = Z3_is_numeral_ast((Z3_context)a0, (Z3_ast)a1);
  return (jboolean) result;
}
DLL_VIS JNIEXPORT jboolean JNICALL Java_com_microsoft_z3_Native_INTERNALisAlgebraicNumber(JNIEnv * jenv, jclass cls, jlong a0, jlong a1) {
  bool result = Z3_is_algebraic_number((Z3_context)a0, (Z3_ast)a1);
  return (jboolean) result;
}
...
DLL_VIS JNIEXPORT jstring JNICALL Java_com_microsoft_z3_Native_INTERNALgetNumeralBinaryString(JNIEnv * jenv, jclass cls, jlong a0, jlong a1) {
  Z3_string result = Z3_get_numeral_binary_string((Z3_context)a0, (Z3_ast)a1);
  return jenv->NewStringUTF(result);
}
...
DLL_VIS JNIEXPORT jdouble JNICALL Java_com_microsoft_z3_Native_INTERNALgetNumeralDouble(JNIEnv * jenv, jclass cls, jlong a0, jlong a1) {
  double result = Z3_get_numeral_double((Z3_context)a0, (Z3_ast)a1);
  return (jdouble) result;
}
...
DLL_VIS JNIEXPORT jboolean JNICALL Java_com_microsoft_z3_Native_INTERNALgetNumeralSmall(JNIEnv * jenv, jclass cls, jlong a0, jlong a1, jobject a2, jobject a3) {
  int64_t _a2;
  int64_t _a3;
  bool result = Z3_get_numeral_small((Z3_context)a0, (Z3_ast)a1, &_a2, &_a3);
  {
     jclass mc    = jenv->GetObjectClass(a2);
     jfieldID fid = jenv->GetFieldID(mc, "value", "J");
     jenv->SetLongField(a2, fid, (jlong) _a2);
...
DLL_VIS JNIEXPORT jboolean JNICALL Java_com_microsoft_z3_Native_INTERNALgetNumeralInt(JNIEnv * jenv, jclass cls, jlong a0, jlong a1, jobject a2) {
  int _a2;
  bool result = Z3_get_numeral_int((Z3_context)a0, (Z3_ast)a1, &_a2);
  {
     jclass mc    = jenv->GetObjectClass(a2);
     jfieldID fid = jenv->GetFieldID(mc, "value", "I");
     jenv->SetIntField(a2, fid, (jint) _a2);
...
DLL_VIS JNIEXPORT jboolean JNICALL Java_com_microsoft_z3_Native_INTERNALgetNumeralUint(JNIEnv * jenv, jclass cls, jlong a0, jlong a1, jobject a2) {
  unsigned _a2;
  bool result = Z3_get_numeral_uint((Z3_context)a0, (Z3_ast)a1, &_a2);
  {
     jclass mc    = jenv->GetObjectClass(a2);
     jfieldID fid = jenv->GetFieldID(mc, "value", "I");
     jenv->SetIntField(a2, fid, (jint) _a2);
...
DLL_VIS JNIEXPORT jboolean JNICALL Java_com_microsoft_z3_Native_INTERNALgetNumeralUint64(JNIEnv * jenv, jclass cls, jlong a0, jlong a1, jobject a2) {
  uint64_t _a2;
  bool result = Z3_get_numeral_uint64((Z3_context)a0, (Z3_ast)a1, &_a2);
  {
     jclass mc    = jenv->GetObjectClass(a2);
     jfieldID fid = jenv->GetFieldID(mc, "value", "J");
     jenv->SetLongField(a2, fid, (jlong) _a2);
...
DLL_VIS JNIEXPORT jboolean JNICALL Java_com_microsoft_z3_Native_INTERNALgetNumeralInt64(JNIEnv * jenv, jclass cls, jlong a0, jlong a1, jobject a2) {
  int64_t _a2;
  bool result = Z3_get_numeral_int64((Z3_context)a0, (Z3_ast)a1, &_a2);
  {
     jclass mc    = jenv->GetObjectClass(a2);
     jfieldID fid = jenv->GetFieldID(mc, "value", "J");
     jenv->SetLongField(a2, fid, (jlong) _a2);
...
DLL_VIS JNIEXPORT jboolean JNICALL Java_com_microsoft_z3_Native_INTERNALgetNumeralRationalInt64(JNIEnv * jenv, jclass cls, jlong a0, jlong a1, jobject a2, jobject a3) {
  int64_t _a2;
  int64_t _a3;
  bool result = Z3_get_numeral_rational_int64((Z3_context)a0, (Z3_ast)a1, &_a2, &_a3);
  {
     jclass mc    = jenv->GetObjectClass(a2);
     jfieldID fid = jenv->GetFieldID(mc, "value", "J");
     jenv->SetLongField(a2, fid, (jlong) _a2);
...
DLL_VIS JNIEXPORT jboolean JNICALL Java_com_microsoft_z3_Native_INTERNALisQuantifierForall(JNIEnv * jenv, jclass cls, jlong a0, jlong a1) {
  bool result = Z3_is_quantifier_forall((Z3_context)a0, (Z3_ast)a1);
  return (jboolean) result;
}
DLL_VIS JNIEXPORT jboolean JNICALL Java_com_microsoft_z3_Native_INTERNALisQuantifierExists(JNIEnv * jenv, jclass cls, jlong a0, jlong a1) {
  bool result = Z3_is_quantifier_exists((Z3_context)a0, (Z3_ast)a1);
  return (jboolean) result;
}
DLL_VIS JNIEXPORT jboolean JNICALL Java_com_microsoft_z3_Native_INTERNALisLambda(JNIEnv * jenv, jclass cls, jlong a0, jlong a1) {
  bool result = Z3_is_lambda((Z3_context)a0, (Z3_ast)a1);
  return (jboolean) result;
}
...
DLL_VIS JNIEXPORT jlong JNICALL Java_com_microsoft_z3_Native_INTERNALmkModel(JNIEnv * jenv, jclass cls, jlong a0) {
  Z3_model result = Z3_mk_model((Z3_context)a0);
  return (jlong) result;
}
...
DLL_VIS JNIEXPORT jboolean JNICALL Java_com_microsoft_z3_Native_INTERNALmodelEval(JNIEnv * jenv, jclass cls, jlong a0, jlong a1, jlong a2, jboolean a3, jobject a4) {
  Z3_ast _a4;
  bool result = Z3_model_eval((Z3_context)a0, (Z3_model)a1, (Z3_ast)a2, (bool)a3, &_a4);
  {
     jclass mc    = jenv->GetObjectClass(a4);
     jfieldID fid = jenv->GetFieldID(mc, "value", "J");
     jenv->SetLongField(a4, fid, (jlong) _a4);
...
DLL_VIS JNIEXPORT jboolean JNICALL Java_com_microsoft_z3_Native_INTERNALmodelHasInterp(JNIEnv * jenv, jclass cls, jlong a0, jlong a1, jlong a2) {
  bool result = Z3_model_has_interp((Z3_context)a0, (Z3_model)a1, (Z3_func_decl)a2);
  return (jboolean) result;
}
...
DLL_VIS JNIEXPORT jlong JNICALL Java_com_microsoft_z3_Native_INTERNALmodelTranslate(JNIEnv * jenv, jclass cls, jlong a0, jlong a1, jlong a2) {
  Z3_model result = Z3_model_translate((Z3_context)a0, (Z3_model)a1, (Z3_context)a2);
  return (jlong) result;
}
DLL_VIS JNIEXPORT jboolean JNICALL Java_com_microsoft_z3_Native_INTERNALisAsArray(JNIEnv * jenv, jclass cls, jlong a0, jlong a1) {
  bool result = Z3_is_as_array((Z3_context)a0, (Z3_ast)a1);
  return (jboolean) result;
}
...
DLL_VIS JNIEXPORT jlong JNICALL Java_com_microsoft_z3_Native_INTERNALaddFuncInterp(JNIEnv * jenv, jclass cls, jlong a0, jlong a1, jlong a2, jlong a3) {
  Z3_func_interp result = Z3_add_func_interp((Z3_context)a0, (Z3_model)a1, (Z3_func_decl)a2, (Z3_ast)a3);
  return (jlong) result;
}
DLL_VIS JNIEXPORT void JNICALL Java_com_microsoft_z3_Native_INTERNALaddConstInterp(JNIEnv * jenv, jclass cls, jlong a0, jlong a1, jlong a2, jlong a3) {
  Z3_add_const_interp((Z3_context)a0, (Z3_model)a1, (Z3_func_decl)a2, (Z3_ast)a3);
}
...
DLL_VIS JNIEXPORT void JNICALL Java_com_microsoft_z3_Native_INTERNALfuncInterpSetElse(JNIEnv * jenv, jclass cls, jlong a0, jlong a1, jlong a2) {
  Z3_func_interp_set_else((Z3_context)a0, (Z3_func_interp)a1, (Z3_ast)a2);
}
...
DLL_VIS JNIEXPORT void JNICALL Java_com_microsoft_z3_Native_INTERNALfuncInterpAddEntry(JNIEnv * jenv, jclass cls, jlong a0, jlong a1, jlong a2, jlong a3) {
  Z3_func_interp_add_entry((Z3_context)a0, (Z3_func_interp)a1, (Z3_ast_vector)a2, (Z3_ast)a3);
}
...
DLL_VIS JNIEXPORT void JNICALL Java_com_microsoft_z3_Native_INTERNALtoggleWarningMessages(JNIEnv * jenv, jclass cls, jboolean a0) {
  Z3_toggle_warning_messages((bool)a0);
}
...
DLL_VIS JNIEXPORT jstring JNICALL Java_com_microsoft_z3_Native_INTERNALbenchmarkToSmtlibString(JNIEnv * jenv, jclass cls, jlong a0, jstring a1, jstring a2, jstring a3, jstring a4, jint a5, jlongArray a6, jlong a7) {
  ...
  jenv->ReleaseStringUTFChars(a1, _a1);
  jenv->ReleaseStringUTFChars(a2, _a2);
  jenv->ReleaseStringUTFChars(a3, _a3);
  jenv->ReleaseStringUTFChars(a4, _a4);
  RELEASELONGAELEMS(a6, _a6);
  return jenv->NewStringUTF(result);
}
DLL_VIS JNIEXPORT jlong JNICALL Java_com_microsoft_z3_Native_INTERNALparseSmtlib2String(JNIEnv * jenv, jclass cls, jlong a0, jstring a1, jint a2, jlongArray a3, jlongArray a4, jint a5, jlongArray a6, jlongArray a7) {
  ...
  Z3_ast_vector result = Z3_parse_smtlib2_string((Z3_context)a0, _a1, (unsigned)a2, _a3, _a4, (unsigned)a5, _a6, _a7);
  jenv->ReleaseStringUTFChars(a1, _a1);
  RELEASELONGAELEMS(a3, _a3);
  RELEASELONGAELEMS(a4, _a4);
  RELEASELONGAELEMS(a6, _a6);
...
DLL_VIS JNIEXPORT jlong JNICALL Java_com_microsoft_z3_Native_INTERNALparseSmtlib2File(JNIEnv * jenv, jclass cls, jlong a0, jstring a1, jint a2, jlongArray a3, jlongArray a4, jint a5, jlongArray a6, jlongArray a7) {
  ...
  GETLONGAELEMS(Z3_symbol, a6, _a6);
  GETLONGAELEMS(Z3_func_decl, a7, _a7);
  Z3_ast_vector result = Z3_parse_smtlib2_file((Z3_context)a0, _a1, (unsigned)a2, _a3, _a4, (unsigned)a5, _a6, _a7);
  jenv->ReleaseStringUTFChars(a1, _a1);
  RELEASELONGAELEMS(a3, _a3);
  RELEASELONGAELEMS(a4, _a4);
  RELEASELONGAELEMS(a6, _a6);
...
DLL_VIS JNIEXPORT jstring JNICALL Java_com_microsoft_z3_Native_INTERNALevalSmtlib2String(JNIEnv * jenv, jclass cls, jlong a0, jstring a1) {
  Z3_string _a1 = (Z3_string) jenv->GetStringUTFChars(a1, NULL);
  Z3_string result = Z3_eval_smtlib2_string((Z3_context)a0, _a1);
  jenv->ReleaseStringUTFChars(a1, _a1);
  return jenv->NewStringUTF(result);
}
...
DLL_VIS JNIEXPORT jlong JNICALL Java_com_microsoft_z3_Native_INTERNALmkGoal(JNIEnv * jenv, jclass cls, jlong a0, jboolean a1, jboolean a2, jboolean a3) {
  Z3_goal result = Z3_mk_goal((Z3_context)a0, (bool)a1, (bool)a2, (bool)a3);
  return (jlong) result;
}
...
DLL_VIS JNIEXPORT jboolean JNICALL Java_com_microsoft_z3_Native_INTERNALgoalInconsistent(JNIEnv * jenv, jclass cls, jlong a0, jlong a1) {
  bool result = Z3_goal_inconsistent((Z3_context)a0, (Z3_goal)a1);
  return (jboolean) result;
}
...
DLL_VIS JNIEXPORT jboolean JNICALL Java_com_microsoft_z3_Native_INTERNALgoalIsDecidedSat(JNIEnv * jenv, jclass cls, jlong a0, jlong a1) {
  bool result = Z3_goal_is_decided_sat((Z3_context)a0, (Z3_goal)a1);
  return (jboolean) result;
}
DLL_VIS JNIEXPORT jboolean JNICALL Java_com_microsoft_z3_Native_INTERNALgoalIsDecidedUnsat(JNIEnv * jenv, jclass cls, jlong a0, jlong a1) {
  bool result = Z3_goal_is_decided_unsat((Z3_context)a0, (Z3_goal)a1);
  return (jboolean) result;
}
...
DLL_VIS JNIEXPORT jlong JNICALL Java_com_microsoft_z3_Native_INTERNALgoalConvertModel(JNIEnv * jenv, jclass cls, jlong a0, jlong a1, jlong a2) {
  Z3_model result = Z3_goal_convert_model((Z3_context)a0, (Z3_goal)a1, (Z3_model)a2);
  return (jlong) result;
}
...
DLL_VIS JNIEXPORT jstring JNICALL Java_com_microsoft_z3_Native_INTERNALgoalToDimacsString(JNIEnv * jenv, jclass cls, jlong a0, jlong a1) {
  Z3_string result = Z3_goal_to_dimacs_string((Z3_context)a0, (Z3_goal)a1);
  return jenv->NewStringUTF(result);
}
...
DLL_VIS JNIEXPORT void JNICALL Java_com_microsoft_z3_Native_INTERNALsolverImportModelConverter(JNIEnv * jenv, jclass cls, jlong a0, jlong a1, jlong a2) {
  Z3_solver_import_model_converter((Z3_context)a0, (Z3_solver)a1, (Z3_solver)a2);
}
...
DLL_VIS JNIEXPORT void JNICALL Java_com_microsoft_z3_Native_INTERNALsolverInterrupt(JNIEnv * jenv, jclass cls, jlong a0, jlong a1) {
  Z3_solver_interrupt((Z3_context)a0, (Z3_solver)a1);
}
...
DLL_VIS JNIEXPORT void JNICALL Java_com_microsoft_z3_Native_INTERNALsolverFromFile(JNIEnv * jenv, jclass cls, jlong a0, jlong a1, jstring a2) {
  Z3_string _a2 = (Z3_string) jenv->GetStringUTFChars(a2, NULL);
  Z3_solver_from_file((Z3_context)a0, (Z3_solver)a1, _a2);
  jenv->ReleaseStringUTFChars(a2, _a2);
}
DLL_VIS JNIEXPORT void JNICALL Java_com_microsoft_z3_Native_INTERNALsolverFromString(JNIEnv * jenv, jclass cls, jlong a0, jlong a1, jstring a2) {
  Z3_string _a2 = (Z3_string) jenv->GetStringUTFChars(a2, NULL);
  Z3_solver_from_string((Z3_context)a0, (Z3_solver)a1, _a2);
  jenv->ReleaseStringUTFChars(a2, _a2);
}
...
DLL_VIS JNIEXPORT jlong JNICALL Java_com_microsoft_z3_Native_INTERNALsolverGetUnits(JNIEnv * jenv, jclass cls, jlong a0, jlong a1) {
  Z3_ast_vector result = Z3_solver_get_units((Z3_context)a0, (Z3_solver)a1);
  return (jlong) result;
}
DLL_VIS JNIEXPORT jlong JNICALL Java_com_microsoft_z3_Native_INTERNALsolverGetTrail(JNIEnv * jenv, jclass cls, jlong a0, jlong a1) {
  Z3_ast_vector result = Z3_solver_get_trail((Z3_context)a0, (Z3_solver)a1);
  return (jlong) result;
}
DLL_VIS JNIEXPORT jlong JNICALL Java_com_microsoft_z3_Native_INTERNALsolverGetNonUnits(JNIEnv * jenv, jclass cls, jlong a0, jlong a1) {
  Z3_ast_vector result = Z3_solver_get_non_units((Z3_context)a0, (Z3_solver)a1);
  return (jlong) result;
}
DLL_VIS JNIEXPORT void JNICALL Java_com_microsoft_z3_Native_INTERNALsolverGetLevels(JNIEnv * jenv, jclass cls, jlong a0, jlong a1, jlong a2, jint a3, jintArray a4) {
  unsigned * _a4 = (unsigned*) jenv->GetIntArrayElements(a4, NULL);
  Z3_solver_get_levels((Z3_context)a0, (Z3_solver)a1, (Z3_ast_vector)a2, (unsigned)a3, _a4);
  jenv->ReleaseIntArrayElements(a4, (jint*)_a4, JNI_ABORT);
}
DLL_VIS JNIEXPORT jlong JNICALL Java_com_microsoft_z3_Native_INTERNALsolverGetImpliedValue(JNIEnv * jenv, jclass cls, jlong a0, jlong a1, jlong a2) {
  Z3_ast result = Z3_solver_get_implied_value((Z3_context)a0, (Z3_solver)a1, (Z3_ast)a2);
  return (jlong) result;
}
DLL_VIS JNIEXPORT jlong JNICALL Java_com_microsoft_z3_Native_INTERNALsolverGetImpliedLower(JNIEnv * jenv, jclass cls, jlong a0, jlong a1, jlong a2) {
  Z3_ast result = Z3_solver_get_implied_lower((Z3_context)a0, (Z3_solver)a1, (Z3_ast)a2);
  return (jlong) result;
}
DLL_VIS JNIEXPORT jlong JNICALL Java_com_microsoft_z3_Native_INTERNALsolverGetImpliedUpper(JNIEnv * jenv, jclass cls, jlong a0, jlong a1, jlong a2) {
  Z3_ast result = Z3_solver_get_implied_upper((Z3_context)a0, (Z3_solver)a1, (Z3_ast)a2);
  return (jlong) result;
}
...
DLL_VIS JNIEXPORT jlong JNICALL Java_com_microsoft_z3_Native_INTERNALsolverCube(JNIEnv * jenv, jclass cls, jlong a0, jlong a1, jlong a2, jint a3) {
  Z3_ast_vector result = Z3_solver_cube((Z3_context)a0, (Z3_solver)a1, (Z3_ast_vector)a2, (unsigned)a3);
  return (jlong) result;
}
...
DLL_VIS JNIEXPORT jstring JNICALL Java_com_microsoft_z3_Native_INTERNALsolverToDimacsString(JNIEnv * jenv, jclass cls, jlong a0, jlong a1, jboolean a2) {
  Z3_string result = Z3_solver_to_dimacs_string((Z3_context)a0, (Z3_solver)a1, (bool)a2);
  return jenv->NewStringUTF(result);
}
...
DLL_VIS JNIEXPORT jboolean JNICALL Java_com_microsoft_z3_Native_INTERNALstatsIsUint(JNIEnv * jenv, jclass cls, jlong a0, jlong a1, jint a2) {
  bool result = Z3_stats_is_uint((Z3_context)a0, (Z3_stats)a1, (unsigned)a2);
  return (jboolean) result;
}
DLL_VIS JNIEXPORT jboolean JNICALL Java_com_microsoft_z3_Native_INTERNALstatsIsDouble(JNIEnv * jenv, jclass cls, jlong a0, jlong a1, jint a2) {
  bool result = Z3_stats_is_double((Z3_context)a0, (Z3_stats)a1, (unsigned)a2);
  return (jboolean) result;
}
...
DLL_VIS JNIEXPORT jlong JNICALL Java_com_microsoft_z3_Native_INTERNALgetEstimatedAllocSize(JNIEnv * jenv, jclass cls) {
  uint64_t result = Z3_get_estimated_alloc_size();
  return (jlong) result;
}
...
DLL_VIS JNIEXPORT jboolean JNICALL Java_com_microsoft_z3_Native_INTERNALastMapContains(JNIEnv * jenv, jclass cls, jlong a0, jlong a1, jlong a2) {
  bool result = Z3_ast_map_contains((Z3_context)a0, (Z3_ast_map)a1, (Z3_ast)a2);
  return (jboolean) result;
}
...
DLL_VIS JNIEXPORT jboolean JNICALL Java_com_microsoft_z3_Native_INTERNALalgebraicIsValue(JNIEnv * jenv, jclass cls, jlong a0, jlong a1) {
  bool result = Z3_algebraic_is_value((Z3_context)a0, (Z3_ast)a1);
  return (jboolean) result;
}
DLL_VIS JNIEXPORT jboolean JNICALL Java_com_microsoft_z3_Native_INTERNALalgebraicIsPos(JNIEnv * jenv, jclass cls, jlong a0, jlong a1) {
  bool result = Z3_algebraic_is_pos((Z3_context)a0, (Z3_ast)a1);
  return (jboolean) result;
}
DLL_VIS JNIEXPORT jboolean JNICALL Java_com_microsoft_z3_Native_INTERNALalgebraicIsNeg(JNIEnv * jenv, jclass cls, jlong a0, jlong a1) {
  bool result = Z3_algebraic_is_neg((Z3_context)a0, (Z3_ast)a1);
  return (jboolean) result;
}
DLL_VIS JNIEXPORT jboolean JNICALL Java_com_microsoft_z3_Native_INTERNALalgebraicIsZero(JNIEnv * jenv, jclass cls, jlong a0, jlong a1) {
  bool result = Z3_algebraic_is_zero((Z3_context)a0, (Z3_ast)a1);
  return (jboolean) result;
}
...
DLL_VIS JNIEXPORT jboolean JNICALL Java_com_microsoft_z3_Native_INTERNALalgebraicLt(JNIEnv * jenv, jclass cls, jlong a0, jlong a1, jlong a2) {
  bool result = Z3_algebraic_lt((Z3_context)a0, (Z3_ast)a1, (Z3_ast)a2);
  return (jboolean) result;
}
DLL_VIS JNIEXPORT jboolean JNICALL Java_com_microsoft_z3_Native_INTERNALalgebraicGt(JNIEnv * jenv, jclass cls, jlong a0, jlong a1, jlong a2) {
  bool result = Z3_algebraic_gt((Z3_context)a0, (Z3_ast)a1, (Z3_ast)a2);
  return (jboolean) result;
}
DLL_VIS JNIEXPORT jboolean JNICALL Java_com_microsoft_z3_Native_INTERNALalgebraicLe(JNIEnv * jenv, jclass cls, jlong a0, jlong a1, jlong a2) {
  bool result = Z3_algebraic_le((Z3_context)a0, (Z3_ast)a1, (Z3_ast)a2);
  return (jboolean) result;
}
DLL_VIS JNIEXPORT jboolean JNICALL Java_com_microsoft_z3_Native_INTERNALalgebraicGe(JNIEnv * jenv, jclass cls, jlong a0, jlong a1, jlong a2) {
  bool result = Z3_algebraic_ge((Z3_context)a0, (Z3_ast)a1, (Z3_ast)a2);
  return (jboolean) result;
}
DLL_VIS JNIEXPORT jboolean JNICALL Java_com_microsoft_z3_Native_INTERNALalgebraicEq(JNIEnv * jenv, jclass cls, jlong a0, jlong a1, jlong a2) {
  bool result = Z3_algebraic_eq((Z3_context)a0, (Z3_ast)a1, (Z3_ast)a2);
  return (jboolean) result;
}
DLL_VIS JNIEXPORT jboolean JNICALL Java_com_microsoft_z3_Native_INTERNALalgebraicNeq(JNIEnv * jenv, jclass cls, jlong a0, jlong a1, jlong a2) {
  bool result = Z3_algebraic_neq((Z3_context)a0, (Z3_ast)a1, (Z3_ast)a2);
  return (jboolean) result;
}
...
DLL_VIS JNIEXPORT jlong JNICALL Java_com_microsoft_z3_Native_INTERNALalgebraicGetPoly(JNIEnv * jenv, jclass cls, jlong a0, jlong a1) {
  Z3_ast_vector result = Z3_algebraic_get_poly((Z3_context)a0, (Z3_ast)a1);
  return (jlong) result;
}
DLL_VIS JNIEXPORT jint JNICALL Java_com_microsoft_z3_Native_INTERNALalgebraicGetI(JNIEnv * jenv, jclass cls, jlong a0, jlong a1) {
  unsigned result = Z3_algebraic_get_i((Z3_context)a0, (Z3_ast)a1);
  return (jint) result;
}
...
DLL_VIS JNIEXPORT jboolean JNICALL Java_com_microsoft_z3_Native_INTERNALrcfLt(JNIEnv * jenv, jclass cls, jlong a0, jlong a1, jlong a2) {
  bool result = Z3_rcf_lt((Z3_context)a0, (Z3_rcf_num)a1, (Z3_rcf_num)a2);
  return (jboolean) result;
}
DLL_VIS JNIEXPORT jboolean JNICALL Java_com_microsoft_z3_Native_INTERNALrcfGt(JNIEnv * jenv, jclass cls, jlong a0, jlong a1, jlong a2) {
  bool result = Z3_rcf_gt((Z3_context)a0, (Z3_rcf_num)a1, (Z3_rcf_num)a2);
  return (jboolean) result;
}
DLL_VIS JNIEXPORT jboolean JNICALL Java_com_microsoft_z3_Native_INTERNALrcfLe(JNIEnv * jenv, jclass cls, jlong a0, jlong a1, jlong a2) {
  bool result = Z3_rcf_le((Z3_context)a0, (Z3_rcf_num)a1, (Z3_rcf_num)a2);
  return (jboolean) result;
}
DLL_VIS JNIEXPORT jboolean JNICALL Java_com_microsoft_z3_Native_INTERNALrcfGe(JNIEnv * jenv, jclass cls, jlong a0, jlong a1, jlong a2) {
  bool result = Z3_rcf_ge((Z3_context)a0, (Z3_rcf_num)a1, (Z3_rcf_num)a2);
  return (jboolean) result;
}
DLL_VIS JNIEXPORT jboolean JNICALL Java_com_microsoft_z3_Native_INTERNALrcfEq(JNIEnv * jenv, jclass cls, jlong a0, jlong a1, jlong a2) {
  bool result = Z3_rcf_eq((Z3_context)a0, (Z3_rcf_num)a1, (Z3_rcf_num)a2);
  return (jboolean) result;
}
DLL_VIS JNIEXPORT jboolean JNICALL Java_com_microsoft_z3_Native_INTERNALrcfNeq(JNIEnv * jenv, jclass cls, jlong a0, jlong a1, jlong a2) {
  bool result = Z3_rcf_neq((Z3_context)a0, (Z3_rcf_num)a1, (Z3_rcf_num)a2);
  return (jboolean) result;
}
DLL_VIS JNIEXPORT jstring JNICALL Java_com_microsoft_z3_Native_INTERNALrcfNumToString(JNIEnv * jenv, jclass cls, jlong a0, jlong a1, jboolean a2, jboolean a3) {
  Z3_string result = Z3_rcf_num_to_string((Z3_context)a0, (Z3_rcf_num)a1, (bool)a2, (bool)a3);
  return jenv->NewStringUTF(result);
}
...
DLL_VIS JNIEXPORT void JNICALL Java_com_microsoft_z3_Native_INTERNALoptimizeAssertAndTrack(JNIEnv * jenv, jclass cls, jlong a0, jlong a1, jlong a2, jlong a3) {
  Z3_optimize_assert_and_track((Z3_context)a0, (Z3_optimize)a1, (Z3_ast)a2, (Z3_ast)a3);
}
...
DLL_VIS JNIEXPORT jint JNICALL Java_com_microsoft_z3_Native_INTERNALoptimizeCheck(JNIEnv * jenv, jclass cls, jlong a0, jlong a1, jint a2, jlongArray a3) {
  GETLONGAELEMS(Z3_ast, a3, _a3);
  int result = Z3_optimize_check((Z3_context)a0, (Z3_optimize)a1, (unsigned)a2, _a3);
  RELEASELONGAELEMS(a3, _a3);
  return (jint) result;
}
...
DLL_VIS JNIEXPORT jlong JNICALL Java_com_microsoft_z3_Native_INTERNALoptimizeGetUnsatCore(JNIEnv * jenv, jclass cls, jlong a0, jlong a1) {
  Z3_ast_vector result = Z3_optimize_get_unsat_core((Z3_context)a0, (Z3_optimize)a1);
  return (jlong) result;
}
...
DLL_VIS JNIEXPORT jlong JNICALL Java_com_microsoft_z3_Native_INTERNALoptimizeGetLowerAsVector(JNIEnv * jenv, jclass cls, jlong a0, jlong a1, jint a2) {
  Z3_ast_vector result = Z3_optimize_get_lower_as_vector((Z3_context)a0, (Z3_optimize)a1, (unsigned)a2);
  return (jlong) result;
}
DLL_VIS JNIEXPORT jlong JNICALL Java_com_microsoft_z3_Native_INTERNALoptimizeGetUpperAsVector(JNIEnv * jenv, jclass cls, jlong a0, jlong a1, jint a2) {
  Z3_ast_vector result = Z3_optimize_get_upper_as_vector((Z3_context)a0, (Z3_optimize)a1, (unsigned)a2);
  return (jlong) result;
}
...
DLL_VIS JNIEXPORT jlong JNICALL Java_com_microsoft_z3_Native_INTERNALmkFpaInf(JNIEnv * jenv, jclass cls, jlong a0, jlong a1, jboolean a2) {
  Z3_ast result = Z3_mk_fpa_inf((Z3_context)a0, (Z3_sort)a1, (bool)a2);
  return (jlong) result;
}
DLL_VIS JNIEXPORT jlong JNICALL Java_com_microsoft_z3_Native_INTERNALmkFpaZero(JNIEnv * jenv, jclass cls, jlong a0, jlong a1, jboolean a2) {
  Z3_ast result = Z3_mk_fpa_zero((Z3_context)a0, (Z3_sort)a1, (bool)a2);
  return (jlong) result;
}
...
DLL_VIS JNIEXPORT jlong JNICALL Java_com_microsoft_z3_Native_INTERNALmkFpaNumeralIntUint(JNIEnv * jenv, jclass cls, jlong a0, jboolean a1, jint a2, jint a3, jlong a4) {
  Z3_ast result = Z3_mk_fpa_numeral_int_uint((Z3_context)a0, (bool)a1, (int)a2, (unsigned)a3, (Z3_sort)a4);
  return (jlong) result;
}
DLL_VIS JNIEXPORT jlong JNICALL Java_com_microsoft_z3_Native_INTERNALmkFpaNumeralInt64Uint64(JNIEnv * jenv, jclass cls, jlong a0, jboolean a1, jlong a2, jlong a3, jlong a4) {
  Z3_ast result = Z3_mk_fpa_numeral_int64_uint64((Z3_context)a0, (bool)a1, (int64_t)a2, (uint64_t)a3, (Z3_sort)a4);
  return (jlong) result;
}
...
DLL_VIS JNIEXPORT jboolean JNICALL Java_com_microsoft_z3_Native_INTERNALfpaIsNumeralNan(JNIEnv * jenv, jclass cls, jlong a0, jlong a1) {
  bool result = Z3_fpa_is_numeral_nan((Z3_context)a0, (Z3_ast)a1);
  return (jboolean) result;
}
DLL_VIS JNIEXPORT jboolean JNICALL Java_com_microsoft_z3_Native_INTERNALfpaIsNumeralInf(JNIEnv * jenv, jclass cls, jlong a0, jlong a1) {
  bool result = Z3_fpa_is_numeral_inf((Z3_context)a0, (Z3_ast)a1);
  return (jboolean) result;
}
DLL_VIS JNIEXPORT jboolean JNICALL Java_com_microsoft_z3_Native_INTERNALfpaIsNumeralZero(JNIEnv * jenv, jclass cls, jlong a0, jlong a1) {
  bool result = Z3_fpa_is_numeral_zero((Z3_context)a0, (Z3_ast)a1);
  return (jboolean) result;
}
DLL_VIS JNIEXPORT jboolean JNICALL Java_com_microsoft_z3_Native_INTERNALfpaIsNumeralNormal(JNIEnv * jenv, jclass cls, jlong a0, jlong a1) {
  bool result = Z3_fpa_is_numeral_normal((Z3_context)a0, (Z3_ast)a1);
  return (jboolean) result;
}
DLL_VIS JNIEXPORT jboolean JNICALL Java_com_microsoft_z3_Native_INTERNALfpaIsNumeralSubnormal(JNIEnv * jenv, jclass cls, jlong a0, jlong a1) {
  bool result = Z3_fpa_is_numeral_subnormal((Z3_context)a0, (Z3_ast)a1);
  return (jboolean) result;
}
DLL_VIS JNIEXPORT jboolean JNICALL Java_com_microsoft_z3_Native_INTERNALfpaIsNumeralPositive(JNIEnv * jenv, jclass cls, jlong a0, jlong a1) {
  bool result = Z3_fpa_is_numeral_positive((Z3_context)a0, (Z3_ast)a1);
  return (jboolean) result;
}
DLL_VIS JNIEXPORT jboolean JNICALL Java_com_microsoft_z3_Native_INTERNALfpaIsNumeralNegative(JNIEnv * jenv, jclass cls, jlong a0, jlong a1) {
  bool result = Z3_fpa_is_numeral_negative((Z3_context)a0, (Z3_ast)a1);
  return (jboolean) result;
}
DLL_VIS JNIEXPORT jlong JNICALL Java_com_microsoft_z3_Native_INTERNALfpaGetNumeralSignBv(JNIEnv * jenv, jclass cls, jlong a0, jlong a1) {
  Z3_ast result = Z3_fpa_get_numeral_sign_bv((Z3_context)a0, (Z3_ast)a1);
  return (jlong) result;
}
DLL_VIS JNIEXPORT jlong JNICALL Java_com_microsoft_z3_Native_INTERNALfpaGetNumeralSignificandBv(JNIEnv * jenv, jclass cls, jlong a0, jlong a1) {
  Z3_ast result = Z3_fpa_get_numeral_significand_bv((Z3_context)a0, (Z3_ast)a1);
  return (jlong) result;
}
...
DLL_VIS JNIEXPORT jboolean JNICALL Java_com_microsoft_z3_Native_INTERNALfpaGetNumeralSignificandUint64(JNIEnv * jenv, jclass cls, jlong a0, jlong a1, jobject a2) {
  uint64_t _a2;
  bool result = Z3_fpa_get_numeral_significand_uint64((Z3_context)a0, (Z3_ast)a1, &_a2);
  {
     jclass mc    = jenv->GetObjectClass(a2);
     jfieldID fid = jenv->GetFieldID(mc, "value", "J");
     jenv->SetLongField(a2, fid, (jlong) _a2);
...
DLL_VIS JNIEXPORT jstring JNICALL Java_com_microsoft_z3_Native_INTERNALfpaGetNumeralExponentString(JNIEnv * jenv, jclass cls, jlong a0, jlong a1, jboolean a2) {
  Z3_string result = Z3_fpa_get_numeral_exponent_string((Z3_context)a0, (Z3_ast)a1, (bool)a2);
  return jenv->NewStringUTF(result);
}
DLL_VIS JNIEXPORT jboolean JNICALL Java_com_microsoft_z3_Native_INTERNALfpaGetNumeralExponentInt64(JNIEnv * jenv, jclass cls, jlong a0, jlong a1, jobject a2, jboolean a3) {
  int64_t _a2;
  bool result = Z3_fpa_get_numeral_exponent_int64((Z3_context)a0, (Z3_ast)a1, &_a2, (bool)a3);
  {
     jclass mc    = jenv->GetObjectClass(a2);
     jfieldID fid = jenv->GetFieldID(mc, "value", "J");
     jenv->SetLongField(a2, fid, (jlong) _a2);
...
DLL_VIS JNIEXPORT jlong JNICALL Java_com_microsoft_z3_Native_INTERNALfpaGetNumeralExponentBv(JNIEnv * jenv, jclass cls, jlong a0, jlong a1, jboolean a2) {
  Z3_ast result = Z3_fpa_get_numeral_exponent_bv((Z3_context)a0, (Z3_ast)a1, (bool)a2);
  return (jlong) result;
}
...
DLL_VIS JNIEXPORT jint JNICALL Java_com_microsoft_z3_Native_INTERNALfixedpointQueryFromLvl(JNIEnv * jenv, jclass cls, jlong a0, jlong a1, jlong a2, jint a3) {
  int result = Z3_fixedpoint_query_from_lvl((Z3_context)a0, (Z3_fixedpoint)a1, (Z3_ast)a2, (unsigned)a3);
  return (jint) result;
}
DLL_VIS JNIEXPORT jlong JNICALL Java_com_microsoft_z3_Native_INTERNALfixedpointGetGroundSatAnswer(JNIEnv * jenv, jclass cls, jlong a0, jlong a1) {
  Z3_ast result = Z3_fixedpoint_get_ground_sat_answer((Z3_context)a0, (Z3_fixedpoint)a1);
  return (jlong) result;
}
DLL_VIS JNIEXPORT jlong JNICALL Java_com_microsoft_z3_Native_INTERNALfixedpointGetRulesAlongTrace(JNIEnv * jenv, jclass cls, jlong a0, jlong a1) {
  Z3_ast_vector result = Z3_fixedpoint_get_rules_along_trace((Z3_context)a0, (Z3_fixedpoint)a1);
  return (jlong) result;
}
DLL_VIS JNIEXPORT jlong JNICALL Java_com_microsoft_z3_Native_INTERNALfixedpointGetRuleNamesAlongTrace(JNIEnv * jenv, jclass cls, jlong a0, jlong a1) {
  Z3_symbol result = Z3_fixedpoint_get_rule_names_along_trace((Z3_context)a0, (Z3_fixedpoint)a1);
  return (jlong) result;
}
DLL_VIS JNIEXPORT void JNICALL Java_com_microsoft_z3_Native_INTERNALfixedpointAddInvariant(JNIEnv * jenv, jclass cls, jlong a0, jlong a1, jlong a2, jlong a3) {
  Z3_fixedpoint_add_invariant((Z3_context)a0, (Z3_fixedpoint)a1, (Z3_func_decl)a2, (Z3_ast)a3);
}
DLL_VIS JNIEXPORT jlong JNICALL Java_com_microsoft_z3_Native_INTERNALfixedpointGetReachable(JNIEnv * jenv, jclass cls, jlong a0, jlong a1, jlong a2) {
  Z3_ast result = Z3_fixedpoint_get_reachable((Z3_context)a0, (Z3_fixedpoint)a1, (Z3_func_decl)a2);
  return (jlong) result;
}
DLL_VIS JNIEXPORT jlong JNICALL Java_com_microsoft_z3_Native_INTERNALqeModelProject(JNIEnv * jenv, jclass cls, jlong a0, jlong a1, jint a2, jlongArray a3, jlong a4) {
  GETLONGAELEMS(Z3_app, a3, _a3);
  Z3_ast result = Z3_qe_model_project((Z3_context)a0, (Z3_model)a1, (unsigned)a2, _a3, (Z3_ast)a4);
  RELEASELONGAELEMS(a3, _a3);
  return (jlong) result;
}
DLL_VIS JNIEXPORT jlong JNICALL Java_com_microsoft_z3_Native_INTERNALqeModelProjectSkolem(JNIEnv * jenv, jclass cls, jlong a0, jlong a1, jint a2, jlongArray a3, jlong a4, jlong a5) {
  GETLONGAELEMS(Z3_app, a3, _a3);
  Z3_ast result = Z3_qe_model_project_skolem((Z3_context)a0, (Z3_model)a1, (unsigned)a2, _a3, (Z3_ast)a4, (Z3_ast_map)a5);
  RELEASELONGAELEMS(a3, _a3);
  return (jlong) result;
}
DLL_VIS JNIEXPORT jlong JNICALL Java_com_microsoft_z3_Native_INTERNALmodelExtrapolate(JNIEnv * jenv, jclass cls, jlong a0, jlong a1, jlong a2) {
  Z3_ast result = Z3_model_extrapolate((Z3_context)a0, (Z3_model)a1, (Z3_ast)a2);
  return (jlong) result;
}
DLL_VIS JNIEXPORT jlong JNICALL Java_com_microsoft_z3_Native_INTERNALqeLite(JNIEnv * jenv, jclass cls, jlong a0, jlong a1, jlong a2) {
  Z3_ast result = Z3_qe_lite((Z3_context)a0, (Z3_ast_vector)a1, (Z3_ast)a2);
  return (jlong) result;
}
#ifdef __cplusplus
}
