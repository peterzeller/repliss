...
public class ExprManager implements ExprManagerI {
  ...
  public Expr mkLeftAssociative(Kind kind, vectorExpr children) {
    return new Expr(CVC4JNI.ExprManager_mkLeftAssociative(swigCPtr, this, kind.swigValue(), vectorExpr.getCPtr(children), children), true);
  }

  public Expr mkRightAssociative(Kind kind, vectorExpr children) {
    return new Expr(CVC4JNI.ExprManager_mkRightAssociative(swigCPtr, this, kind.swigValue(), vectorExpr.getCPtr(children), children), true);
  }
  ...
  public DatatypeType mkDatatypeType(Datatype datatype, long flags) {
    return new DatatypeType(CVC4JNI.ExprManager_mkDatatypeType__SWIG_0(swigCPtr, this, Datatype.getCPtr(datatype), datatype, flags), true);
  }

  public DatatypeType mkDatatypeType(Datatype datatype) {
    return new DatatypeType(CVC4JNI.ExprManager_mkDatatypeType__SWIG_1(swigCPtr, this, Datatype.getCPtr(datatype), datatype), true);
  }

  public vectorDatatypeType mkMutualDatatypeTypes(vectorDatatype datatypes, long flags) {
    return new vectorDatatypeType(CVC4JNI.ExprManager_mkMutualDatatypeTypes__SWIG_0(swigCPtr, this, vectorDatatype.getCPtr(datatypes), datatypes, flags), true);
  }

  public vectorDatatypeType mkMutualDatatypeTypes(vectorDatatype datatypes) {
    return new vectorDatatypeType(CVC4JNI.ExprManager_mkMutualDatatypeTypes__SWIG_1(swigCPtr, this, vectorDatatype.getCPtr(datatypes), datatypes), true);
  }

  public vectorDatatypeType mkMutualDatatypeTypes(vectorDatatype datatypes, setOfType unresolvedTypes, long flags) {
    return new vectorDatatypeType(CVC4JNI.ExprManager_mkMutualDatatypeTypes__SWIG_2(swigCPtr, this, vectorDatatype.getCPtr(datatypes), datatypes, setOfType.getCPtr(unresolvedTypes), unresolvedTypes, flags), true);
  }

  public vectorDatatypeType mkMutualDatatypeTypes(vectorDatatype datatypes, setOfType unresolvedTypes) {
    return new vectorDatatypeType(CVC4JNI.ExprManager_mkMutualDatatypeTypes__SWIG_3(swigCPtr, this, vectorDatatype.getCPtr(datatypes), datatypes, setOfType.getCPtr(unresolvedTypes), unresolvedTypes), true);
  }
  ...
  public SortConstructorType mkSortConstructor(String name, long arity, long flags) {
    return new SortConstructorType(CVC4JNI.ExprManager_mkSortConstructor__SWIG_0(swigCPtr, this, name, arity, flags), true);
  }

  public SortConstructorType mkSortConstructor(String name, long arity) {
    return new SortConstructorType(CVC4JNI.ExprManager_mkSortConstructor__SWIG_1(swigCPtr, this, name, arity), true);
  }
  ...
  public final static int DATATYPE_FLAG_NONE = CVC4JNI.ExprManager_DATATYPE_FLAG_NONE_get();
  public final static int DATATYPE_FLAG_PLACEHOLDER = CVC4JNI.ExprManager_DATATYPE_FLAG_PLACEHOLDER_get();
