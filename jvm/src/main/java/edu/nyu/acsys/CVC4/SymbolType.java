...
public final class SymbolType {
  public final static SymbolType SYM_VARIABLE = new SymbolType("SYM_VARIABLE");
  public final static SymbolType SYM_SORT = new SymbolType("SYM_SORT");
  ...
  private static SymbolType[] swigValues = { SYM_VARIABLE, SYM_SORT };
