theory task3bdtrpls_CrdtProgram_WP_parameter_createBoard_2
imports Why3
begin

why3_open "task3bdtrpls_CrdtProgram_WP_parameter_createBoard_2.xml"
...
proof -
  ...
  obtain assign1 
    where a1: "state_visibleCalls2 assign1"
      ...
      and a3: "\<And>assign2. \<lbrakk>state_callOps2 assign2 = Op_task_columnid_assign t c1;  state_visibleCalls2 assign2;  assign1 \<noteq> assign2\<rbrakk> \<Longrightarrow>  \<not> state_happensBefore2 assign2 assign1"
