theory task3ddtrpls_CrdtProgram_WP_parameter_moveTask_1
imports Why3
begin

why3_open "task3ddtrpls_CrdtProgram_WP_parameter_moveTask_1.xml"
...
proof -
  ...
  (* use old invariant: *)
    ...
    have assign1_op: "state_callOps1 assign1 = Op_task_columnid_assign t c1"
      by (smt False H41 H49 H57 H65 H72 fun_upd_same fun_upd_triv fun_upd_twist operation.distinct(301) operation.distinct(333) operation.distinct(441))
