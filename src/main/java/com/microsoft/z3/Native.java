...
//   }
  ...
  protected static native String INTERNALgoalToDimacsString(long a0, long a1);
  ...
  protected static native long INTERNALsolverGetImpliedValue(long a0, long a1, long a2);
  protected static native long INTERNALsolverGetImpliedLower(long a0, long a1, long a2);
  protected static native long INTERNALsolverGetImpliedUpper(long a0, long a1, long a2);
  ...
  public static String goalToDimacsString(long a0, long a1) throws Z3Exception
  {
      String res = INTERNALgoalToDimacsString(a0, a1);
      Z3_error_code err = Z3_error_code.fromInt(INTERNALgetErrorCode(a0));
      if (err != Z3_error_code.Z3_OK)
          throw new Z3Exception(INTERNALgetErrorMsg(a0, err.toInt()));
      return res;
  ...
  public static long solverGetImpliedValue(long a0, long a1, long a2) throws Z3Exception
  {
      long res = INTERNALsolverGetImpliedValue(a0, a1, a2);
      Z3_error_code err = Z3_error_code.fromInt(INTERNALgetErrorCode(a0));
      if (err != Z3_error_code.Z3_OK)
          throw new Z3Exception(INTERNALgetErrorMsg(a0, err.toInt()));
      return res;
  ...
  public static long solverGetImpliedLower(long a0, long a1, long a2) throws Z3Exception
  {
      long res = INTERNALsolverGetImpliedLower(a0, a1, a2);
      Z3_error_code err = Z3_error_code.fromInt(INTERNALgetErrorCode(a0));
      if (err != Z3_error_code.Z3_OK)
          throw new Z3Exception(INTERNALgetErrorMsg(a0, err.toInt()));
      return res;
  ...
  public static long solverGetImpliedUpper(long a0, long a1, long a2) throws Z3Exception
  {
      long res = INTERNALsolverGetImpliedUpper(a0, a1, a2);
      Z3_error_code err = Z3_error_code.fromInt(INTERNALgetErrorCode(a0));
      if (err != Z3_error_code.Z3_OK)
          throw new Z3Exception(INTERNALgetErrorMsg(a0, err.toInt()));
      return res;
